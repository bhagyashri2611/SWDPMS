...
@Component({
  ...
  template: `<button cButton color="info" size="sm" style="background-color: #39f;border-radius: 4px;border: none;"  (click)="btnClickedViewDetailsHandler()"> View Details</button> 
  `,
})
